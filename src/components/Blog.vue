      ...
      >
        <div class="flex flex-row">
          ...
          <div class="flex flex-col">
            ...
            <div
              class="font-nunito text-left text-sm 
              text-secondaryLightGray font-light font-nunito mx-6 mb-2"
            > {{ item.description }}
            </div>
          </div>
        </div>
        ...
        >
          <span class="my-auto mx-2 text-sm 0"
            >Read</span>
          <img
...
export default {
  ...
  data: {
    blogs: [],
    images:['src/assets/art_3.jpg','src/assets/art_4.jpg','src/assets/art_2.jpg'
             ,'src/assets/oranges.jpg','src/assets/book_on_face.jpg', 
             'src/assets/spiral.jpg','src/assets/idea.jpg']
  },
  methods: {
    fetchBlogs(ref) {
      onValue(
